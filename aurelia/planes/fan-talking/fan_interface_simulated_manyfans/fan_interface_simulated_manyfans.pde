...
void setup() {
  ...
  String portName = Serial.list()[3]; // tell processing the port that communicates with arduino
...
void draw() {
  ...
  for (int i=0; i<fans.length; i++) {
    ...
    arduinoMessage = arduinoMessage + fans[i].motorval + ", ";
  }
